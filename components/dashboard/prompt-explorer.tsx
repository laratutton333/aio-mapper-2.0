...
function intentPillClass(value: IntentFilter | null) {
  if (value === "comparative")
    return "bg-emerald-500/10 text-emerald-700 border-emerald-500/15 dark:text-emerald-300";
  if (value === "informational")
    return "bg-blue-600/10 text-blue-700 border-blue-600/15 dark:text-blue-300";
  if (value === "transactional")
    return "bg-amber-500/10 text-amber-700 border-amber-500/15 dark:text-amber-300";
  if (value === "trust")
    return "bg-slate-100 text-slate-700 border-slate-200 dark:bg-slate-800/60 dark:text-slate-200 dark:border-slate-700";
  return "bg-white text-slate-600 border-slate-200 dark:bg-slate-950 dark:text-slate-300 dark:border-slate-800";
}
...
function mentionPillClass(value: MentionType) {
  ...
  return "bg-white text-slate-500 border-slate-200 dark:bg-slate-950 dark:text-slate-400 dark:border-slate-800";
}
          ...
          <div className="absolute right-0 top-0 h-full w-full max-w-xl overflow-y-auto overflow-x-hidden border-l border-slate-200 bg-white p-6 text-slate-900 shadow-2xl dark:border-slate-800 dark:bg-slate-950 dark:text-slate-100">
            ...
            <div className="mt-6 space-y-6">
              <div>
                ...
                <div className="mt-3 break-words rounded-xl border border-slate-200 bg-slate-50 p-4 text-sm text-slate-700 dark:border-slate-800 dark:bg-slate-900/40 dark:text-slate-100">
              ...
              <div>
                ...
                <div className="mt-3 break-words whitespace-pre-wrap rounded-xl border border-slate-200 bg-slate-50 p-4 text-sm text-slate-700 dark:border-slate-800 dark:bg-slate-900/40 dark:text-slate-100">
                  ...
                  {selectedDetail.citations.length === 0 ? (
                    ...
                    selectedDetail.citations.map((citation) => (
                      <div
                        ...
                        className="flex items-center justify-between rounded-xl border border-slate-200 bg-white px-4 py-3 dark:border-slate-800 dark:bg-slate-900/30"
                      >
                        <div className="flex items-center gap-3">
                          ...
                          <span className="text-sm text-slate-700 dark:text-slate-200">{citation.domain}</span>
                        </div>
                  ...
                  {[
                    ...
                    <div key={row.label}>
                      <div className="flex items-center justify-between text-sm">
                        ...
                        <span className="text-slate-900 dark:text-slate-200">{percent(row.value)}</span>
                      </div>
                      <div className="mt-2">
